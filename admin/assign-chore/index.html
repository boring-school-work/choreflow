      ...
      <div class="text-center w-1/6 py-4 px-5">
        ...
        <div class="flex flex-col h-[89vh] justify-between">
          <div class="flex flex-col grow mt-8">
            <a href="../dashboard/" class="py-2 bg-gray-50 mb-2 rounded"
              >Home</a
            >
            <a href="../add-chore/" class="py-2 bg-gray-50 rounded mb-2"
              >Add Chore</a
            >
            <a href="../assign-chore/" class="py-2 bg-gray-50 mb-2 rounded"
              >Assign Chore</a
            >
          </div>
          <div class="flex gap-x-2 justify-around">
            <a class="bg-blue-200 px-5 py-1 rounded-md" href="../../register"
              >Register</a
            >
            <a class="bg-blue-200 px-5 py-1 rounded-md" href="../../login"
              >Login</a
            >
          </div>
        </div>
      ...
      <div class="grow">
        ...
        <main class="bg-gray-100 h-[89vh] px-8">
          <div class="flex justify-between">
            ...
            <button
              class="bg-gray-300 my-9 px-2 shadow-sm rounded-md"
              type="button"
            >
              Assign a chore
            </button>
