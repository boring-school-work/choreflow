        ...
        <div class="grow">
            ...
            <main class="bg-gray-100 h-[89vh] px-8">
                <div class="flex justify-between">
                    ...
                    <!-- Dialog with form -->
                    <dialog id="dialog"
                        class="bg-white-200 bg-opacity-50 w-1/3 h-1/3 relative top-1/4 left-1/3 p-3 rounded-lg">
                        ...
                        <form action="" method="post" name="addChore" id="addChore"
                            class="flex flex-col items-center text-center justify-center">
                            <input type="text" placeholder="Enter chore" id="choreInput"
                                class="w-1/2 mb-4 border py-3 px-2 rounded-md border-blue-300 accent-blue-300" required>
                            <button type="submit" name="submitChore" id="submitChore"
                                class="bg-blue-300 px-3 py-2 rounded-md">Submit</button>
                        </form>
                    </dialog>
