        ...
        <div class="grow">
            ...
            <main class="bg-gray-100 h-[89vh] px-8">
                <div class="flex justify-between">
                    ...
                    <!-- Dialog with form -->
                    <dialog id="dialog"
                        class="bg-white-200 bg-opacity-50 w-1/3 h-1/2 relative top-1/4 left-1/3 p-3 rounded-lg">
                        ...
                        <form action="" method="post" name="assignChore" id="assignChore"
                            ...
                            <div class="flex justify-center items-center text-left">
                                ...
                                <input type="date" name="due-date" id="due-date" class="py-2 px-3 rounded-md"
                                    required />
                            </div>
                            <br>
                            <button type="submit" name="submitAssignment" id="submitAssignment"
                                class="bg-blue-300 px-3 py-2 rounded-md">Assign</button>
                        </form>
                    </dialog>
