...
<body>
  ...
  <div class="bg-gray-100 h-screen text-center flex flex-col pt-20">
    ...
    <form action="" method="post" name="register" id="register">
      ...
      <div class="flex flex-row place-content-center gap-x-3 mb-4">
        ...
        <div class="flex flex-col text-left mb-1 w-1/5">
          ...
          <select name="family_role" class="w-64 py-1.5 px-1 rounded-md bg-white">
            <option value="">Pick a family role</option>
            <?php
      ...
      <div class="flex flex-row place-content-center gap-x-3 mb-4">
        <div class="flex flex-col text-left mb-1 w-1/5">
          <label for="dob">Date of birth</label><input type="date" name="dob" id="dob" class="py-2 px-3 rounded-md" required />
        </div>
        <div class="flex flex-col text-left mb-1 w-1/5">
          <label for="tel">Telephone</label><input type="tel" name="tel" id="tel" class="py-2 px-3 rounded-md" placeholder="Enter your phone number" />
        </div>
      </div>
      <div class="grid grid-cols-2 place-content-center gap-x-3 mb-4">
        ...
        <div class="w-[40%]">
          <input class="w-full py-2 px-3 rounded-md" type="text" name="email" placeholder="Email" />
        </div>
      </div>
      <div class="grid grid-cols-2 place-content-center gap-x-3 mb-4">
        <div class="place-self-end self-center">
